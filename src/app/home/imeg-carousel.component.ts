...
export class ImegCarouselComponent implements AfterViewInit, OnDestroy {
    ...
    start(): void {
        ...
        console.log('imeg carousel started: ' + this.intervalId);
    }
    ...
    stop(): void {
        ...
        if (this.intervalId) {
            ...
            console.log('imeg carousel stopped: ' + this.intervalId);
        } else {
            console.log('imeg carousel not started');
        }

    }

    toggleCaptionHover(): void {
        this.captionHover = this.captionHover === 'hover' ? '' : 'hover';
    }
